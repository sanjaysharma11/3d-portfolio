...
const AboutSection = (props) => {
  ...
  return (
    ...
    <motion.p
      className="text-lg text-gray-100 mt-4 md:w-[44%]"
      initial={{
        opacity: 0,
        y: 25,
      }}
    ...
    >
      I make Creative, interactive and performant web apps.<br />
      I love to build things that stand out and make people say <br />
      "Wow!".
    </motion.p>
    <section className="flex gap-8">
      <motion.button
        onClick={() => setSection(3)}
        className="bg-purple-500 text-white py-4 px-8 rounded-lg font-bold text-lg mt-8 hover:bg-purple-400 transition-all duration-300 ease-in-out"
        initial={{
          opacity: 0,
          y: 25,
        }}
      ...
      <motion.button
        ...
        className="bg-purple-500 text-white py-4 px-8 rounded-lg font-bold text-lg mt-8 flex space-x-2 justify-center items-center text-center hover:bg-purple-400 transition-all duration-300 ease-in-out"
        initial={{
          opacity: 0,
          y: 25,
        }}
...
const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("access_key", "5e64a71b-628f-4891-bb55-58913c9e14ca");
